...
#### 🏆 Σκορμπόρντ με μνήμη
- Το **καλύτερο σκορ** αποθηκεύεται αυτόματα στον browser (localStorage) και παραμένει ακόμα και αν κλείσεις τη σελίδα!
- Η μπάρα σκορ δείχνει πάντα: ⭐ τρέχον σκορ · ❓ ερώτηση · 🏆 Καλύτερο
- Αν κάνεις **νέο ρεκόρ**, εμφανίζεται χρυσό banner με animation: **🎉 ΝΕΟ ΡΕΚΟΡ!**
- Μικρός σύνδεσμος στο υποσέλιδο για **Μηδενισμός ρεκόρ**

#### 🃏 Κάρτες Μελών με Fun Facts
- Κάνε κλικ σε ένα μέλος και εμφανίζεται αμέσως μια **κάρτα πληροφοριών** με slide-in animation
- Κάθε κάρτα δείχνει: emoji, όνομα, σημαία χώρας, ρόλο στο γκρουπ και ένα διασκεδαστικό γεγονός!
- Ροζ/μοβ gradient, στρογγυλές γωνίες, ομαλή κίνηση εισόδου

#### 🔊 Ήχοι με Web Audio API
- **Σωστή απάντηση:** ανερχόμενη μελωδία 3 νοτών (Do-Mi-Sol)
- **Λάθος απάντηση:** κατερχόμενος θλιβερός ήχος
- **Επιλογή μέλους:** sparkle εφέ (γρήγορες ψηλές νότες)
- **Έναρξη παιχνιδιού:** σύντομο fanfare
- **Νέο ρεκόρ:** πανηγυρική μελωδία 5 νοτών
- Κουμπί 🔊/🔇 για ενεργοποίηση/απενεργοποίηση ήχου — χωρίς εξωτερικά αρχεία!

#### 💃 Animation Χορευτή
- Χαριτωμένος **χορευτής από CSS** (divs/spans, χωρίς εικόνες) στη γωνία της οθόνης
- Χορεύει απαλά σε συνεχή βρόχο με ροζ/μοβ χρώματα
- **Σωστή απάντηση:** κάνει μεγάλο πανηγυρισμό — γυρίζει και πηδάει για 2 δευτερόλεπτα!
- **Λάθος απάντηση:** κάνει θλιβερή κλίση για 1 δευτερόλεπτο
- Δεν κρύβει κανένα στοιχείο της σελίδας
